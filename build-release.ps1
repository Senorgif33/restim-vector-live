...
$files = @("vector1a", "tests", "README.md", "RELEASE_NOTES_1.6.0-alpha49.md", "LICENSE", "THIRD_PARTY_NOTICES.md", "CONTRIBUTING.md", "SECURITY.md", "pyproject.toml", "start-vector1a.bat", "build-release.ps1", "build-release.bat")
